...
function Hero() {
  return (
    <div>
      <h1 className="text-4xl font-medium text-center leading-tight">Vi sikrer at virksomheder får <br /><span className="text-green-hl">professionel</span> hjælp til at få flyttet deres <br /> produktion op på en <span className="text-green-hl">moderne <br /> </span> fremtidssikret IT platform.</h1>
