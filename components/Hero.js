      ...
      <div className="my-auto mx-auto xxsm:mt-6 lgbasemd:mt-20 max-w-6xl">
        <div className="">
          <div className="absolute baselg:block xxsm:hidden">
            <video autoPlay muted loop className="-z-40 border-t-16 border-l-16 border-gray-100 relative object-none object-right-bottom float-right w-1/2 h-screen big:h-max rounded-l-xl">
              <source
