    ...
    <div>
      <div className="">
        <video
          ...
          muted
          loop
          className="absolute smbig:max-h-screen smbig:w-full top-0 -z-50 xxsm:invisible basemd:h-5/6 lgbasemd:h-auto basemd:visible w-auto"
        >
          <source
      ...
      <div className=" my-auto mx-auto xxsm:mt-6 lgbasemd:mt-20 max-w-6xl">
        <div className="">
          ...
          <p className="text-xl basemd:text-white xxsm:ml-10 max-w-md xxsm:pr-8 xxsm:text-sm xxsm:mt-8 xsm:mt-8 basemd:mt-2 1xl:mt-12">
            <Fade>ERP Produktion hjalp os med at strømline vores flow, og skabe en 20%
            tidsbesparelse i virksomheden.</Fade>
          </p>
        </div>
        <a href="#footer">
          <Fade>
