...
<div className='text-center'>
                    <h3 className='text-lg sm:text-xl md:text-xl 2xl:text-2xl font-bold'>ERP Gruppen</h3>
                    <h1 className='text-4xl sm:text-5xl md:text-7xl 2xl:text-8xl font-bold mt-10'>
                        Gratis webinar
                    </h1>
                    <p className='max-w-5xl mx-auto text-base md:text-lg mt-10 font-light'>Tag på gratis webinar og bliv klogere på mulighederne med Microsoft Dynamics 365 løsninger.
