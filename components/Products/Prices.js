					...
					<table className="text-center w-full">
						<thead className="bg-black flex text-white w-full">
							<tr className="flex w-full mb-4">
								...
								<th className="p-4 w-1/4">Basic</th>
								<th className="p-4 w-1/4">Essential</th>
								<th className="p-4 w-1/4">Premium</th>
							</tr>
						</thead>
						<tbody className="flex flex-col items-center justify-between w-full">
							...
							<tr className="flex w-full mb-4 divide-white divide-x-8">
								<td className="p-4 w-1/4 bg-gray-100">Dogs</td>
								<td className="p-4 w-1/4 bg-gray-100">Cats</td>
								<td className="p-4 w-1/4 bg-gray-100">Birds</td>
								<td className="p-4 w-1/4 bg-gray-100">Fish</td>
							</tr>
							<tr className="flex w-full mb-4">
