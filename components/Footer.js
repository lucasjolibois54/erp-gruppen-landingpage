    ...
    <div>
      <div className="bg-gray-100 pt-5 m-10 ml-10 mr-10 mx-auto">
        ...
        <div className="bg-gray-100 w-full" ><div className="float-right bg-gray-100 w-full text-right pr-10 pb-5 mb-6">
          ...
          <p className=" bg-gray-100 w-full inline-block text-right p-3 pt-0 mb-5"><Link Link href="/betingelser"><span>Betingelser</span></Link> & <Link Link href="/politik"><span>Politik</span></Link></p></div>
        </div>
      </div>
    </div>
