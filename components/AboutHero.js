        ...
        <div>
            ...
            <div>
                <div className="max-w-7xl mx-auto px-10">
                    <h2 className="font-semibold text-white xxsm:text-xl xsm:text-2xl ourservice:text-3xl basemd:text-5xl baselg:text-6xl text-center base2lg:text-7xl big:text-7xl pt-20 leading-regular">
